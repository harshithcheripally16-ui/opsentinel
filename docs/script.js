document.addEventListener('DOMContentLoaded', () => {
    ...
    function updateMetrics() {
        ...
        try {
            ...
            console.log('[Opsentinel Trace] Simulated Response Generated:', data);
        } catch (error) {
            console.error('[Opsentinel Trace] Simulation heartbeat failed:', error);
    ...
    async function fetchSystemInfo() {
        try {
            ...
            console.error('[Opsentinel Trace] Failed to load simulated info:', error);
        }
    }
    ...
    if (isDemo) {
        console.log('[Opsentinel Trace] Demo mode detected. Showing dashboard immediately.');
